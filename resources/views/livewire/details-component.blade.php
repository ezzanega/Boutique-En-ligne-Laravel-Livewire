                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider" wire:ignore>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop') }}/{{ $product->image }}" alt="product image">
                                            </figure>
                                            @php
                                            ...
                                            @foreach ($images as $image)
                                                @if ($image)
                                                    <figure class="border-radius-10">
                                                        <img src="{{ asset('assets/imgs/shop') }}/{{ $image }}" alt="#">
                                                    </figure>
                                                @endif
                                            @endforeach
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15" wire:ignore>
                                            @foreach ($images as $image)
                                                @if($image)
                                                    <div><img src="{{ asset('assets/imgs/shop') }}/{{ $image }}" alt="{{ $product->name }}"></div>
                                                @endif
                                            @endforeach
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                                <div class="float-left product-price primary-color">
                                                    ...
                                                    <ins><span class="old-price font-md ml-15 regprice">${{ $product->regular_price }}</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            <div class="border detail-qty radius" wire:model='qty'>
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li>Availability:<span class="ml-5 in-stock text-success">{{ $product->quantity }} Items In Stock</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="Description">
                                        <div class="">
                                            ...
                                            <p>Spluttered narrowly yikes left moth in yikes bowed this that grizzly much hello on spoon-fed that alas rethought much decently richly and wow against the frequent fluidly at formidable acceptably flapped besides
                                                and much circa far over the bucolically hey precarious goldfinch mastodon goodness gnashed a jellyfish and one however because.
                                            </p>
                                            ...
                                            <p>Scallop or far crud plain remarkably far by thus far iguana lewd precociously and and less rattlesnake contrary caustic wow this near alas and next and pled the yikes articulate about as less cackled dalmatian
                                                in much less well jeering for the thanks blindly sentimental whimpered less across objectively fanciful grimaced wildly some wow and rose jeepers outgrew lugubrious luridly irrationally attractively dachshund.
                                            </p> --}}
                                        </div>
                                    </div>
                                                ...
                                                <div class="product-cart-wrap small hover-up">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="product-price">
                                                            @if($rproduct->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
