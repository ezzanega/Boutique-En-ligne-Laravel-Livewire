<main class="main single-page">
        ...
        <div class="container pt-25">
            <div class="row mb-50">
                <div class="text-center col-lg-12 col-md-12">
                    ...
                    <p class="m-auto w-50 text-grey-3 wow fadeIn animated">At vero eos et accusamus et iusto odio dignissimos ducimus quiblanditiis praesentium. ebitis nesciunt voluptatum dicta reprehenderit accusamus</p>
                </div>
            </div>
            ...
            <div class="row mt-30">
                <div class="text-center col-12">
                    <p class="wow fadeIn animated">
                        <a class="text-white btn btn-brand btn-shadow-brand hover-up btn-lg">View More</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding">
        <div class="container pb-25">
            <h3 class="mb-20 text-center section-title wow fadeIn animated"><span>Featured</span> Clients</h3>
