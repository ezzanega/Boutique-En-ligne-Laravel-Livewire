                                ...
                                <table class="table text-center shopping-summery clean">
                                    ...
                                    <tbody>
                                        @foreach (Cart::instance('cart')->content() as $item)
                                            <tr>
                                                <td class="image product-thumbnail"><img src="{{ ('assets/imgs/shop') }}/{{ $item->model->image }}" alt="{{ $item->model->name }}"></td>
                                                ...
                                                <td class="text-center" data-title="Stock">
                                                    <div class="m-auto border detail-qty radius">
                                                        <a class="qty-down" href="#"><i class="fi-rs-angle-small-down" wire:click.prevent="decreaseQuantity('{{ $item->rowId }}')"></i></a>
                                                        <span class="qty-val" value="{{ $item->qty }}">{{ $item->qty }}</span>
                                                        <a class="qty-up" href="#"><i class="fi-rs-angle-small-up" wire:click.prevent="increaseQuantity('{{ $item->rowId }}')"></i></a>
                                                    </div>
                                                </td>
                                        ...
                                        @endforeach
                                            <td colspan="6" class="text-end">
                                                <a href="#" wire:click.prevent="destroyAll()" class="text-muted"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="row mb-50">
                                ...
                                <div class="mb-30 mt-50">
                                    @if(!Session::has('coupon'))
                                        ...
                                        <div class="total-amount">
                                            <div class="left">
                                                <div class="coupon">
                                                    <form target="_blank" wire:submit.prevent="applyCouponCode">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                            ...
                                            <tbody>
                                                    ...
                                                    @if(Session::has('coupon'))
                                                        <tr>
                                                            ...
                                                            <td class="cart_total_amount"><span class="font-lg fw-900 text-brand"> - ${{ number_format($discount,2) }} <a href="#" wire:click.prevent='removeCoupon'><i class="fi fi-rs-cross-small text-danger"></i></a></span></td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <a href="#" class="btn " wire:click.prevent='checkout'> <i class="mr-10 fi-rs-box-alt"></i> Proceed To CheckOut</a>
                                </div>
                            </div>
                        </div>
                    </div>
